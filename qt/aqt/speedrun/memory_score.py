...
SUBDECK_TO_SECTION: dict[str, str] = {
    ...
    "Behavioral": "P/S",
    # CARS has no flashcard deck — it appears in performance scores only.
    "CARS": "CARS",
}
...
# Topics that have no flashcard deck and are scored by questions only.
QUESTIONS_ONLY_TOPICS: frozenset[str] = frozenset({"CARS"})
